            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  minLength={6}
                  className="w-full border border-border bg-transparent px-4 py-3 pr-12 text-sm text-foreground focus:outline-none focus:border-foreground transition-colors"
                />
                <button
                  type="button"
