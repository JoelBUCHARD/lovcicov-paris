...
const BASE_ORDER: { id: string; imageOverride?: string; nameOverride?: string; keySuffix?: string }[] = [
  ...
  { id: "powerlov-if-god-dj-frequency", imageOverride: "powerlov-psd-street-back", nameOverride: "PRETTY. SMART. DANGEROUS.", keySuffix: "-back" },
        ...
        <section aria-label="Sélection PowerLov" style={{ padding: "clamp(24px, 4vw, 56px) clamp(12px, 3vw, 40px) 4px" }}>
          ...
          {(() => {
            ...
            const renderCard = (item: GridItem, i: number, opts: { appendedRow?: boolean; total?: number }) => {
              ...
              const isLandscape = !uniformMode && !isAppended && ((opts.total !== undefined && i === opts.total - 1 && i % 5 !== 0 && i < 10) || i === 10);
                  ...
                  >
                    ...
                    >
                      <img
                        ...
                        style={
                          image.includes("cream-sweat-nyc-walking")
                            ? { objectPosition: "center 30%", transform: "scale(1.25)", transformOrigin: "center 30%" }
                            : image.includes("lovcicov-2019-bird")
