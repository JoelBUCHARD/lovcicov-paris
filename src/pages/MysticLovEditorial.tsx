      ...
      <div className="pt-[73px]">
        ...
        <section className="flex flex-col md:flex-row w-full" style={{ minHeight: "auto" }}>
          <div className="w-full md:w-1/2 h-[55vh] md:h-auto flex items-center justify-center p-4 md:p-6">
            <img src={seatedRooftop} alt="L'histoire MysticLov" className="w-full h-full object-cover" style={{ objectPosition: "center 25%" }} />
          </div>
          <div
            ...
            {[duoRooftop, greenTee, hoodieRooftop, rooftopArmsOpen, hoodieMadonnaParis, rooftopMadonna].map((img, i) => (
              <div key={i} className="relative w-full overflow-hidden" style={{ aspectRatio: "1 / 1" }}>
                <img
                  ...
                  className="absolute inset-0 w-full h-full object-cover"
                  style={{ objectPosition: i === 1 || i === 2 || i === 3 || i === 4 ? "center 15%" : "center center" }}
                />
              </div>
            ))}
          </div>
