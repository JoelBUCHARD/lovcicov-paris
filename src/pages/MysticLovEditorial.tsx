...
import seatedRooftop from "@/assets/mysticlov/mysticlov-block3-fullbody-shoes.png.asset.json";
    ...
    <div style={{ backgroundColor: BG, scrollBehavior: "smooth" }} className="min-h-screen">
      ...
      <div className="pt-[73px]">
        ...
        <section className="w-full overflow-hidden" style={{ backgroundColor: BG }}>
          <div className="w-full h-[55vh] md:h-[85vh] overflow-hidden">
            <img
              src={seatedRooftop.url}
              alt="L'histoire MysticLov"
              className="w-full h-full object-cover scale-[1.25] md:scale-110 object-[center_20%] md:object-[center_35%]"
            />
          </div>
        </section>
