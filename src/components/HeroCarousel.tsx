...
import slide4landscape from '@/assets/slide4-landscape.jpeg';
...
const slides: Slide[] = [
  ...
  { images: [], landscape: slide4landscape },
];
          ...
          >
            {slides.map((slide, i) => (
              <div key={i} className="w-full flex-shrink-0">
                {slide.landscape ? (
                  <div className={`overflow-hidden bg-[#F0EBE3] ${i === 0 ? 'aspect-[21/9]' : 'aspect-[16/9]'}`}>
                    <img
                      src={slide.landscape}
                      alt={`Slide ${i + 1}`}
