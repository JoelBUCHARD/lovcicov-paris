...
const universeConfig = {
  ...
  sacs: { label: 'LOVBAG', accent: '#8B6A4A', back: '/sacs', backLabel: 'Sacs', recitBg: '#F6F1EB' },
      ...
      <div className="grid grid-cols-1 md:grid-cols-[minmax(0,1fr)_minmax(380px,440px)] gap-8 md:gap-16 max-w-[1100px] mx-auto">
        ...
        >
          ...
          {product.collection === 'mystic' && product.subcategory === 'tshirt' && (
            ...
            >
              Coton 100% peigné, grammage lourd 240&nbsp;g/m². Coupe oversize unisexe, épaules tombées, encolure côtelée. Broderie dorée signature.
            </p>
          )}
            ...
            <ul className="list-none p-0 m-0 space-y-1.5">
              {(isJewelry
                ...
                : [
                    ...
                    product.collection === 'mystic' ? 'Broderie dorée signature au fil métallisé' : 'Sérigraphie signature haute densité',
                  ]
              ).map((d) => (
