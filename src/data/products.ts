...
export const standardProducts: Product[] = [
  {
    ...
    gallery: ['powerlov-discipline-back-white', 'powerlov-discipline-front-white'],
    badge: 'UNISEX',
  },
  {
    ...
    image: 'powerlov-pretty-smart-dangerous-hallway-cap',
    gallery: ['powerlov-pretty-smart-dangerous-tshirt-front', 'powerlov-pretty-smart-dangerous-tshirt-back'],
    badge: 'UNISEX',
  },
  {
  ...
  },
  {
    ...
    gallery: ['powerlov-god-is-a-dancer-flat-white-front', 'powerlov-god-is-a-dancer-flat-white-back'],
    badge: 'UNISEX',
  },
  {
  ...
  },
  {
    ...
    detailImage: 'powerlov-iconic-stairs-red-boots',
  ...
  },
  {
    ...
    image: 'powerlov-perfectly-imperfect-hoodie-cafe-croissant-v2',
    detailImage: 'powerlov-perfectly-imperfect-hoodie-cafe-croissant-v2',
    gallery: ['powerlov-perfectly-imperfect-hoodie-cream-front-v3', 'powerlov-perfectly-imperfect-hoodie-cream-back-v3'],
    badge: 'UNISEX',
  },
  {
  ...
  },
  {
    ...
    gallery: ['powerlov-lovcicov-2029-bird-flat-front', 'powerlov-lovcicov-2029-bird-flat-back'],
    badge: 'UNISEX',
  },
  {
    ...
    gallery: ['powerlov-lovcicov-tshirt-white-flat-front', 'powerlov-lovcicov-tshirt-white-flat-back'],
    badge: 'UNISEX',
  },
  {
  ...
  },
  {
    ...
    detailImage: 'powerlov-lovcicov-2019-bird-market-back-walking',
    gallery: ['powerlov-lovcicov-2019-bird-my-own-muse-front', 'powerlov-lovcicov-2019-bird-cream-back-packshot'],
    badge: 'UNISEX',
  },
  {
...
export const mysticProducts: Product[] = [
  ...
  },
  {
    ...
    collection: 'mystic',
    subcategory: 'crewneck',
    description: 'Crewneck LOVE, mantra brodé or, symbole universel d\'ouverture du cœur. Georgiana a choisi le crewneck pour sa simplicité monastique : un vêtement quotidien transformé en talisman. Broderie dorée · Coton premium.',
  ...
  },
  {
    ...
    collection: 'mystic',
    subcategory: 'tshirt',
    description: '« Namaste Bitches », Namasté signifie "le divin en moi salue le divin en toi". Georgiana a ajouté l\'irrévérence pour rappeler que la spiritualité n\'est pas tiède : elle s\'affirme. Broderie dorée · Coton premium.',
  ...
  },
  {
    ...
    collection: 'mystic',
    subcategory: 'tshirt',
    description: 'Carte du Tarot : Le Monde. Intention : accomplissement, expansion, unité. À porter dans les moments de bascule, quand un cycle se ferme et qu\'un autre commence. Georgiana a choisi le cosmos parce qu\'il rappelle notre place, vaste et précise, dans l\'univers. Broderie dorée · Coton premium.',
  ...
  },
  {
    ...
    collection: 'mystic',
    subcategory: 'tshirt',
    description: 'Carte du Tarot : Le Soleil. Intention : joie, vitalité, rayonnement. À porter les jours où l\'on choisit la lumière, où l\'on refuse de se rétrécir. Georgiana a choisi ce symbole pour les âmes solaires, celles qui réchauffent sans calculer. Broderie dorée · Coton premium.',
  ...
  },
  {
    ...
    collection: 'mystic',
    subcategory: 'tshirt',
    description: 'Carte du Tarot : Le Mat. Intention : oser, sauter, faire confiance. À porter au début d\'un cycle, d\'un projet, d\'une histoire. Georgiana l\'a brodé comme un rappel quotidien : la magie ne vient jamais sans risque. Broderie dorée · Coton premium.',
  ...
  },
  {
    ...
    collection: 'mystic',
    subcategory: 'tshirt',
    description: 'Art brut comme acte spirituel : laisser parler la matière sans filtre. Georgiana a choisi cette composition libre comme un hommage aux artistes-médiums, celles et ceux qui peignent ce qu\'ils ressentent avant de le comprendre. Broderie dorée · Coton premium.',
