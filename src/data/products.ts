...
export const standardProducts: Product[] = [
  {
    ...
    collection: 'standard',
    subcategory: 'tshirt',
    description: 'Coton lourd 280g, coupe oversize. Sérigraphie « DISCIPLINE IS MY LUXURY ». Unisex, Made in France.',
    details: 'Pour celles et ceux qui font de la discipline leur plus grand luxe.',
    image: 'powerlov-tshirt-discipline',
    badge: 'UNISEX',
  },
  {
    ...
    collection: 'standard',
    subcategory: 'tshirt',
    description: 'Coton lourd 280g, coupe oversize. Sérigraphie « CONNECTED. DISCIPLINED. EMPOWERED. » et empreinte de baiser rouge. Unisex, Made in France.',
