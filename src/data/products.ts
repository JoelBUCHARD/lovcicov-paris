...
export const products: Product[] = [
  ...
  {
    id: 'oversized-tee',
    name: 'Le T-Shirt Oversize',
    price: 145,
    collection: 'signature',
    description: 'Coton organique 220g. Coupe loose et fluide.',
    details: 'Pensé pour l\'aisance et une confiance discrète.',
    image: 'product-shirt',
    state: 'Confiant',
  },
  {
  ...
  },
  {
    ...
    price: 290,
    collection: 'mystic',
    description: 'Molleton épais 360g. Broderie symbolique subtile.',
    details: 'Confort et présence dans chaque détail.',
